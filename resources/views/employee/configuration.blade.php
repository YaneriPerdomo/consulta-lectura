                        ...
                        <span class="form__icon input-group-text p-0 @error ('cedula') is-invalid--border @enderror" id="basic-addon1">
                            <div class="input-group">
                                <select id="type-indicator" name="identity_card_id" class="form-control form__select " >
                                    ...
                                    @if ($data_employee)
                                        @switch($data_employee->identity_card_id)
                                            @case($data_employee->identity_card_id == 1)
                                                <option value="1" selected> Venezolano cedulado (V) </option>
                                            @break
                                            @case($data_employee->identity_card_id == 2)
                                                <option value="2"  selected> Extranjero cedulado (E)</option>                                                
                                            @break
                                            @case($data_employee->identity_card_id == 3)
                        ...
                        <span class="form__icon input-group-text p-0 w-100" id="basic-addon1">
                            <div class="input-group">
                                <select id="gender_id" name="gender_id" class="form-control form__select " required>
                                     <option value="" disabled>Seleccione una opción</option>
                                    @if ($data_employee)
                                        @switch($data_employee->gender_id)
                                            @case(1)
                            ...
                            <div class="input-group">
                                <select id="job_id" name="job_id" class="form-control form__select " required>
                                    ...
                                    @foreach ( $jobs as $value )
                                         @if ($data_employee->job_id == $value['job_id'])
                                         <option value="{{ $value['job_id'] }}"   selected> {{$value['job']}}</option>
                                        @endif 
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="input-group">
                                <select id="room_id" name="room_id" class="form-control form__select " required>
                                    ...
                                    @foreach ( $rooms as $value )
                                           ...
                                           <option value="{{ $value['room_id'] }}"      selected  > {{$value['room']}}</option>
                                            @endif
