...
<body class="h-100 d-flex flex-column">
    ...
    <main class="flex__grow-2 flex-full__aligh-start">
        <form action="{{ route('employee.book.store') }}" method="post" class="form form--employee">
            @csrf
                            ...
                            <div class="input-group ">
                                <select id="type-indicator" name="author_id" class="form-control form__select " required>
                                    ...
                                    @foreach ($authors as $value)
                                        <option value="{{ $value->author_id }}"> {{ $value->author }} </option>
                                    @endforeach
                                </select>
                            </div>
                        </span>
                                ...
                                <select id="type-indicator" name="editorial_id" class="form-control form__select "
                                    ...
                                    <option value="" selected disabled>Seleccione una opción</option>
                                     @foreach ($editorials as $value)
                                        <option value="{{ $value->editorial_id }}"> {{ $value->editorial }} </option>
                                    @endforeach
                                </select>
                            </div>
                        </span>
                ...
                <div class="form__item">
                    ...
                    <div class="input-group ">
                        ...
                        <input type="number" id="isbn" name="isbn" class="form-control
                            ...
                            aria-describedby="basic-addon1" autofocus value="{{ old('isbn')}}">
                    </div>
                    @error('isbn')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
